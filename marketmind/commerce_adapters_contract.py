...
COMMERCE_IMPORT_BATCH_NOT_FOUND_DETAIL = "Import batch not found"
COMMERCE_IMPORT_BATCH_ID_KEY = "batch_id"
AD_CSV_BODY_KEY = "csv_text"
COMMERCE_AD_SUMMARY_HAS_DATA_KEY = "has_data"
AD_SPEND_SUMMARY_RESPONSE_KEYS: tuple[str, ...] = ("has_data", "summary")
IMPORT_HISTORY_STRIPE_SOURCE = "stripe_charges"
IMPORT_HISTORY_SOURCE_QUERY = "source"

DESKTOP_LIVE_DATA_TEST_PATH = "desktop/src/components/LiveData.test.tsx"

COMMERCE_READINESS_COMMERCE_KEY = "commerce"
COMMERCE_INTEGRATIONS_MODULE_PATH = "marketmind/commerce_integrations.py"
...
LIVE_DATA_SHOPIFY_PRODUCTS_LABEL = "Shopify Products"
