...
- **Current phase:** Hardening — Phase B pass 25 complete (experiment lifecycle r4); see `SLICE_WORKFLOW.md`
- **Last reviewed:** 2026-06-24
- **Test inventory:** ~800 pytest + 28 desktop Vitest files; `tests/test_docs_drift_contract.py` + `tests/test_experiment_lifecycle_contract.py` guard parity
- **Known blockers:** None
